...
<body>
    ...
    <p>
        <a style='color: #DAA520; text-decoration: none' href="cadastrar_cliente.php">Cadastre-se no sistema</a>
    </p>
    ...
    <div>
        ...
        <p>
            <a style='color: #DAA520; text-decoration: none' href="cadastrar_cliente.php">Sair do Sistema</a>
        </p>
    </div>
</body>
